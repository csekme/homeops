...
import { Money, InvalidMoneyError, CurrencyMismatchError, bankersRound, } from "./money.js";
...
describe("Money arithmetic", () => {
    ...
    it("throws on cross-currency add", () => {
        expect(() => new Money(100, "EUR").add(new Money(50, "USD"))).toThrow(CurrencyMismatchError);
    });
    it("throws on cross-currency subtract", () => {
        expect(() => new Money(100, "EUR").subtract(new Money(50, "USD"))).toThrow(CurrencyMismatchError);
    });
});
