...
import huHouseholds from "./locales/hu/households.json" with { type: "json" };
...
import enHouseholds from "./locales/en/households.json" with { type: "json" };
