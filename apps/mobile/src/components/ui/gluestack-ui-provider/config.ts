...
export const config = {
  light: vars({
    /* HomeOps brand blue (from @homeops/tokens primary #2563eb = primary-600). */
    '--color-primary-0': '245 249 255',
  ...
  dark: vars({
    /* HomeOps brand blue (dark): a bright ramp so primary surfaces pop on dark backgrounds. */
