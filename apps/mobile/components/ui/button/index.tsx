...
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- see alert/index.tsx
...
>(({ className, size, ...props }, ref) => {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- ActivityIndicator's `size`
  // (number | 'small' | 'large') differs from the tva size variant; cast to keep behaviour.
