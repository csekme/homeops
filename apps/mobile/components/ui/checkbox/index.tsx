...
// NOTE: the alpha CLI emits `@gluestack-ui/core/icon/creator` here, which fails typecheck;
// the project re-exports a typed UIIcon from the local icon module (see actionsheet/badge).
