...
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- nativewind 4.2's cssInterop
// types reject the `true` / 'classNameColor' style→prop mapping the gluestack icon needs at
// runtime; cast keeps the vendored behaviour while satisfying the stricter types.
