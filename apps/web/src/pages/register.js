...
export default function RegisterPage() {
    ...
    if (isSuccess) {
        return (<AuthShell title={t('register.title')}>
        <Empty>
          <EmptyHeader>
    ...
    return (<AuthShell title={t('register.title')} footer={<span className="text-muted-foreground">
      ...
      <form onSubmit={onSubmit} noValidate>
        <FieldGroup>
          ...
          <Field data-invalid={!!errors.displayName}>
            ...
            <Input id="displayName" autoComplete="name" aria-invalid={!!errors.displayName} {...form.register('displayName')}/>
