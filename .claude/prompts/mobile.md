...
- **CLI**: `npx gluestack-ui@alpha add <component>`
- **Theming**: CSS variables defined in `global.css` with `@theme inline` mappings
- **Engines**: NativeWind v5 or UniWind
- **Docs**: https://v5.gluestack.io/ui/docs
